...
> Alternatively you can setup an isolated dev environment for contributing using our docker image `[here](../tools/README.md#doom-contrib-docker-image-start_dockersh) ⚠️ fix this`.
